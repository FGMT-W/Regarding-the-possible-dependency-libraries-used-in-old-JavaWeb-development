        ...
        <c:forEach items="${goodsList }" var="good">
        	<!-- 动态数据时使用，已经修改过css -->
		            <div style="background-color: #fff;width: 234px;height:320px;float: left;margin-left: 11px; ">
		            	<a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}" target="_blank">
		            		<img class="time_min" style="width:234px;height: 234px;" src="<%=imgPath %>${good.pic}" title="${good.description }">
		            	</a>
                    	...
                    	<!-- 循环后台取到的家电的集合 -->
                    		<!-- 动态获取数据时使用，已经修改过css -->
                   		  ...
                   		  <c:if test="${i.count<5 }">
                  			...
                  			<a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}" target="_blank"><img width="180px" height="180px;" src="<%=imgPath %>${good.pic}" alt=""></a>
                  		...
                  		<c:if test="${i.count>=5 }">
                  			...
                  			<a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}"><img width="180px" height="180px;" src="<%=imgPath %>${good.pic}" title="${good.full_description }"></a>
                  			<div style="width: 234px;height: 100px;">
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">${good.gname }</div>
                  				<div style="width: 100%;height: 33px;text-align: center;font-size: 14px;font-family: Arial">
                  				<c:if test="${good.description.length()<12 }">
        ...
        <div class="capacity">
            <div class="capa_box_top">
            	...
            	<div class="capa_box scrip_capa_box scrip_capa_box_on">
                	<div class="capa_top">
                    	<!-- 智能家居 - 动态使用  -->
                    	<c:forEach items="${goodsZhineng }" var="good">
                    	<div class="capa capa_shadow" style="width: 231px;height: 301px;text-align: center;background-color: #FFFFFF;margin-top: 15px;">
	                        <a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}" target="_blank"><img width="180px" height="180px" src="<%=imgPath%>${good.pic}">
	                            <div class="tran">
        ...
        <div class="capacity">
            ...
            <div class="capa_box">
                <div class="capa_top">
					...
					<!-- 动态数据使用，仅供参考 -->
					<c:forEach items="${tjGoods }" var="good">
	                	<div class="capa capa_shadow" style="margin-right: 10px;background-color: #fff">
	                        <a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}"><img width="234"  src="<%=imgPath %>${good.pic}">
	                        </a>
	                        <div class="capa_a">
	                            <ul>
	                                <li style="color: #333333"> ${good.gname } </li>
	                                <li style="color: #b0b0b0"> ${good.description } </li>
	                                <li style="font-size: 14px;margin-top: 10px; color: #ff6700" >${good.price } 元</li>
	                            </ul>
	                        </div>
	                    </div>
    ...
    <div class="popular">
        <div class="popular_background">
            ...
            <div class="popu_box">
            	...
            	<!-- 动态数据使用，仅供参考 -->
            	<c:forEach items="${goodsRemen }" var="good" varStatus="i">
            		<c:if test="${i.count ==1 }">
            			<div class="popu popu_unleft popu_shadow" >
	                        <a href="<%=basePath %>index?method=findGoodByGid&gid=${good.gid}" target="_blank"><img style="width: 296px" height="220px" src="<%=imgPath %>${good.pic}"></a>
