...
<body>
    ...
    <div class="trolley_background">
        <div class="trolley_background_in">
            ...
            <c:set var="sum_number" value="0"></c:set>
            <c:forEach items="${tList }" var="trolley">
	            <div class="tro_tab_h1">
	                ...
	                <div class="col tro_tab_img">
	                    <img src="<%=imgPath %>${trolley.good.pic}" alt="">
	
	                </div>
	                <div class="col tro_tab_name">
	                <!--<h2 tro_tab_name_h2>小米电视4A 32英寸 黑色 32英寸</h2>-->
	               <li class="tro_tab_name_li1" style="font-size: 16px;">${trolley.good.gname }&nbsp;${trolley.good.color }</li>
	                </div>
	                <div class="col tro_tab_price">
	                    <span  id="price">${trolley.good.price }</span><span>元</span>
	                </div>
	                <div class="col tro_tab_num">
	                    ...
	                    <c:set var="sum_number" value="${sum_number + trolley.number}"></c:set>
	                ...
	                <span class="tro_tab_total_value" id="prices" >${trolley.number*trolley.good.price }</span>元
	                 <c:set var="sum_price" value="${sum_price+trolley.number*trolley.good.price}"></c:set>
	                </div>
        ...
        <div class="tro_close_bot ">
            ...
            <p class="tro_close_p "> <a href="indexServlet?fs=index">继续购物 </a>  | 共<span>${tList.size() }</span>种商品|共<span>${sum_number }</span>件商品</p>
...
<script type="text/javascript">
	...
	function addOrDeleteNumber(tid,number) {
		...
		window.location="trolley?method=addOrDeleteNumber&tid="+tid+"&number="+number;
	}	
	//删除购物车记录
	function delTrolley(tid) {
		if(confirm("确定要删除吗？")){
			window.location="trolley?method=delTrolley&tid="+tid;
		}
	}
	//去结算
